...
public class AddArt extends AppCompatActivity {
    ...
    public void save(View view) {
        ...
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP); //intent öncesi tüm aktiviteleri kapatmamıza olanak sağlar.
        startActivity(intent);

        //finish();
    }

    public Bitmap makeSmallerImage(Bitmap image, int maximumSixe) {
